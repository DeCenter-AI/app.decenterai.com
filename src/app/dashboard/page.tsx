        ...
        <DashLayout >
            <div className='h-full max-h-screen w-full px-2 overflow-y-scroll  text-white'>
                ...
                <div className='my-10 flex gap-5 '>
                    <div className='w-[70%] rounded-xl border border-primary_9 h-[481px] px-8 py-8'>
                        ...
                        <div className='overflow-y-scroll h-[85%]'>
                            <div className='flex items-center gap-5 my-4 '>
                                ...
                                <div className='grow pb-5 border-b-2 border-primary_9'>
                                    <div className='mb-3'>
                                        <span className='px-2 py-1 text-[12px] text-primary_7 rounded-full bg-primary_9'>Crankshaft</span>
                                    </div>
                                    <div className='mb-3'>
