            ...
            <div className='flex flex-col items-center justify-start w-[80%] md:w-[60%]  h-[80%] gap-3'>
                ...
                <div className='w-full h-[20%] flex flex-col gap-2'>
                    ...
                    <div className='h-[80%] border border-primary_8 rounded-2xl w-full  text-sm flex justify-between items-center font-archivo px-4'>
                        ...
                        <textarea className='w-full h-full rounded-2xl bg-transparent focus:ring-0 outline-none p-2 resize-none' placeholder='what is the model about...' />
                    </div>
                </div>
                <div className='h-[10%] rounded-2xl w-full  text-sm flex justify-between items-center font-archivo '>
                    <button onClick={() => setPage(1)} className="border border-primary_8 text-primary_1 font-semibold font-primaryArchivo text-sm h-full w-[30%] cursor-pointer rounded-2xl">
                        Train again
                    </button>
                    <button onClick={() => download()} className="bg-primary_11 text-primary_1 font-semibold font-primaryArchivo text-sm h-full w-[30%] cursor-pointer rounded-2xl">
                        Download Model
                    </button>
                </div>
            </div>
