        ...
        <div className=" ">
          <div className="flex gap-3 max-h-screen h-[80%] text-white mb-4 text-xs  ">
            <div className="bg-[#05050538] px-4 py-5 h-[242px] rounded-lg  ">
              ...
              <div className="mt-3">
                <span className="text-xs border border-[#232323] px-3 mt-4 py-1 rounded-full">
                  Feature Extraction
                </span>
              </div>
            </div>
            ...
            <div className=" w-[80%] max-h-screen h-[80%] ">
              <div className=" border border-[#494949] mb-4 flex px-5 py-3 rounded-xl  h-[150px]">
                <div className="mt-2 grow">
                  <div>
                    <span className="bg-[#232323] rounded-full text-[#5D5D5D] py-2 px-3">
                      Text Generation
                    </span>
                  </div>
                  <div className="mt-4">
                ...
                <div className="h-[108px] w-[115px] bg-[#232323] mt-2"></div>
              </div>
