            ...
            <form className="h-[45%] flex flex-col gap-4 text-primary_1">
              <div className="h-[30%] flex flex-col">
                ...
                <input
                  ...
                  className="block h-[90%] focus:outline-none focus:ring-1 focus:bg-transparent ring-primary_7 focus:border-none border border-primary_11 rounded-xl px-6 bg-transparent text-sm font-archivo"
                />
              </div>
              <div className="h-[30%] flex flex-col">
                <div className="h-[30%] ">
                ...
                <div className="h-[90%] border border-primary_11 rounded-xl relative">
                  ...
                  <input
                    ...
                    className="h-full w-full focus:outline-none focus:ring-1 focus:bg-transparent ring-primary_7 rounded-xl  pl-6 pr-12 bg-transparent text-sm font-archivo outline-none"
                  />
                </div>
              </div>
            ...
            <div className="h-[45%] flex flex-col gap-3">
              ...
              <div className="text-primary_8 text-xs font-archivo ">
                ...
                <p className="font-light text-center">
                  Are you new here?{' '}
                  <span className="text-primary_1 pl-3 cursor-pointer">
                    {' '}
                    Create Account
                  </span>{' '}
                </p>
